...
export function createReportRoutes(reportController: ReportController): Router {
  ...
  router.get('/profit-loss', authenticate, authorize('reports:read'), asyncHandler(reportController.profitLoss.bind(reportController)));
  ...
  router.get('/profit-loss/export', authenticate, authorize('reports:read'), asyncHandler(reportController.exportProfitLoss.bind(reportController)));
