...
export function createModifierRoutes(modifierController: ModifierController): Router {
  ...
  router.post('/', authenticate, authorize('products:write'), asyncHandler(modifierController.create.bind(modifierController)));
  router.put('/:id', authenticate, authorize('products:write'), asyncHandler(modifierController.update.bind(modifierController)));
  router.delete('/:id', authenticate, authorize('products:write'), asyncHandler(modifierController.delete.bind(modifierController)));
