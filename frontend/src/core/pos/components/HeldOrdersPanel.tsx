    ...
    <>
      ...
      {heldOrders.length > 0 && (
        <button
          ...
          className={`fixed left-0 top-16 z-40 flex items-center gap-1 bg-amber-500 text-white px-2 py-4 rounded-r-lg shadow-lg hover:bg-amber-600 transition-all font-bold text-sm ${
            heldOrdersPanelOpen ? 'translate-x-[280px]' : ''
          }`}
          style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}
        >
          <svg className="w-4 h-4 rotate-90 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
